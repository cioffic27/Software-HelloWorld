...
int main()
{
	...
	if (command == "YES")
	{
		...
		cout << "move, pickup/pick up, use, inventory/items, commands, turn, quit/exit" << endl;			//New Issue Ticket 221
		while (room1.room1_finished != true)
		{
			...
			if (command == "MOVE")
				...
				room1.Inventory();
			else if (command == "TURN")			//New Issue Ticket 221
				cout << "It is currently turn " << turn << endl << endl;			//New Issue Ticket 221
			else if (command == "QUIT" || command == "EXIT")
				exit;
			else
				cout << "That is not a valid command" << endl;
		}
		cout << "You completed Room 1.\nIt took you " << turn << " turns to get to this point.\n\n";			//New Issue Ticket 221
		...
		if (room1.room1_finished == true && room2.room2_finished == true && room3.room3_finished == true)
		{
			...
			cout << "It took you " << turn << " to complete the rooms.\n\n";
		}
		cin >> command;
	}
	else if (command == "NO")
