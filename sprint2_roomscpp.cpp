...
int main()
{
	...
	if (command == "YES")
	{
		while (playing == true)
		{
			...
			cout << "It took you " << room1.turn << " turns to get through room 1.  You have " << turn_cap-total_turns-1 << " turns remaining." << endl<<endl;
			...
			cout << "It took you " << room2.turn << " turns to get through room 2.  You have " << turn_cap-total_turns-1 << " turns remaining." << endl<<endl;
			...
			cout << "It took you " << room3.turn << " turns to get through room 3.  You have " << turn_cap-total_turns-1<< " turns remaining." << endl<<endl;
