...
int main()
{
	...
	if (command == "YES")
	{
		while (playing == true)
		{
			...
			cout << "Depending on the difficulty you select, you will have a set amount of turns to escape all four rooms before you lose" << endl;
			...
			cout << "It took you " << room1.turn << " turns to get through room 1.  You have " << total_turns - room1.turn << " turns remaining" << endl;
			...
			cout << "It took you " << room2.turn << " turns to get through room 2.  You have " << total_turns - room2.turn << " turns remaining" << endl;
			...
			cout << "It took you " << room3.turn << " turns to get through room 3.  You have " << total_turns - room3.turn << " turns remaining" << endl;
			...
			cout << "You walk through the door and enter a dark hallway.  You see a faint light in the distance and carefully make your way towards the light.\n " << endl;
			cout << "When you reach the end of the hallway you see the outline of trees and realize you are outside and have been able to finally escape the house." << endl;
			cout << "Congratulations you were able to complete the game in " << room1.turn + room2.turn + room3.turn + room4.turn << " turns!" << endl;
